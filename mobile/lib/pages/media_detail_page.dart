...
class _MediaDetailPageState extends State<MediaDetailPage> {
  ...
  // These start as whatever the list/catalog view already had (usually
  // placeholders like 'N/A' for runtime, since fetching full details for
  // every item in a grid would be far too many API calls) and get
  // replaced once the real detail fetch completes.
